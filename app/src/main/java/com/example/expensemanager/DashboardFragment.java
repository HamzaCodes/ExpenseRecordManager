...
public class DashboardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fabEdit =myview.findViewById(R.id.fb_main_plus_btn);
        fabIncome =myview.findViewById(R.id.income_ft_btn);
        fabExpense =myview.findViewById(R.id.expense_ft_btn);
    ...
    private void floatingButtonAnimation(){
        if(isOpen){
            fabIncome.startAnimation(fadeClose);
            fabExpense.startAnimation(fadeClose);
            ...
            fabIncome.startAnimation(fadeOpen);
            fabExpense.startAnimation(fadeOpen);
